using System.Linq;
using Godot;
using Lawfare.scripts.logic.conditions.diff.quantity;
...
[GlobalClass]
public partial class HasWitnessQuantityDiff: EventCondition
{
    [Export]
    ...
    public override bool Evaluate(GameEvent gameEvent)
    {
        ...
        var condition = new IsWitnessQuantityDiff(_property, _amountCondition);
